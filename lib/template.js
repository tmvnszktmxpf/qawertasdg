  ...
  html: function (title, list, body, control, authStatusUI = `<a href="/login">login</a> | <a href="/login/register">register</a>`) {
    return `
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://eldkqmffh8.ml/styles/style.css"></link>
        <script src="https://eldkqmffh8.ml/js/hello.js""></script>
      </head>
      <body>
        ${authStatusUI}
        <h1><a href="/">WEB</a></h1>
    ...
    products.forEach(product => {
      list += `
        <div class="card">
        <img class="card__image" src="${product[3]}" alt="wave" />
        ...
        <div class="card-flap flap1">
          ...
          <div class="card-flap flap2">
            <div class="card-actions">
              <a href="https://class101.net/products/${product[1]}" target='_blank' class="btn">보러가기</a>
            </div>
          </div>
        </div>
      </div>
