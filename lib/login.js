...
register = function (request, response) {
    ...
    var html = template.html(title, list,
        ...
        <p><input type="text" name="name" placeholder="name" value = "zxcvzxbc"></p>
        <p><input type="text" name="email" placeholder="email" value="zxcv@gmail.com"></p>
        <p><input type="password" name="password" placeholder="password" value = "zxcvklhasdkg&*^Y*YUIG&*^"></p>
        <p><input type="password" name="password2" placeholder="password" value = "zxcvklhasdkg&*^Y*YUIG&*^"></p>
    ...
    if (post.password !== post.password2) {
        ...
        conn.query(`
          INSERT INTO user (id,name, password,email) 
            VALUES(?, ?,?,?)`,
            [id, post.name, post.password, post.email],
